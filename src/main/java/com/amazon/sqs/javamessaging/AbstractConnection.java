...
public abstract class AbstractConnection implements QueueConnection {
    ...
    public QueueSession createQueueSession(boolean transacted,
        ...
        if (acknowledgeMode == Session.AUTO_ACKNOWLEDGE) {
            ...
            sqsSession = createSession(this, AcknowledgeMode.ACK_RANGE.withOriginalAcknowledgeMode(acknowledgeMode));

        } else if (acknowledgeMode == SQSSession.UNORDERED_ACKNOWLEDGE) {
            sqsSession = createSession(this, AcknowledgeMode.ACK_UNORDERED.withOriginalAcknowledgeMode(acknowledgeMode));
     ...
     * @throws JMSException          On internal error or called if close is in progress.
     */
    @Override
    public void stop() throws JMSException {
        ...
        if (getSessionThreadFactory().wasThreadCreatedWithThisThreadGroup(Thread.currentThread())) {
    ...
    void setActionOnConnectionTaken(@SuppressWarnings("SameParameterValue") boolean actionOnConnectionTaken) {
