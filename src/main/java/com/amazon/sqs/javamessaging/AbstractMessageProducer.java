...
public abstract class AbstractMessageProducer<SQS_CLIENT extends AmazonSQS> implements QueueSender {
    ...
    public void send(Message message) throws JMSException {
        ...
        sendMessageInternal(sqsDestination, message, null);
    }
    ...
    //region MessageProducer Methods
    ...
    SendMessageRequest getSendMessageRequest(SQSQueueDestination queue, Message rawMessage) throws JMSException {
        SQSMessage message = checkMessageFormat(rawMessage);
    ...
    //region Unit Tests Utility Methods
